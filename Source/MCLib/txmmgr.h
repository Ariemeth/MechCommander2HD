...
#define MC_MAXTEXTURES				32768
#define CACHED_OUT_HANDLE			0xFFFFFACE		//If this value is in gosTextureHandle, texture is cached out and must be cached in.
#define MAX_MC2_GOS_TEXTURES		6000
#define TEXTURE_CACHE_SIZE			(320*1024*1024)	//Extra space here to facilitate editting
#define MAX_CACHE_SIZE				(320*1024*1024)	//Actual amount map must run in!
#define MC_MAXFACES					500000
#define MAX_LZ_BUFFER_SIZE			((256*256*320) + 1024)
